...
2. Realize I need to install Jekyll. [Install Jekyll for Windows][https://jekyllrb.com/docs/installation/windows/]
3. Realize I need ruby. Download and install the `Ruby+Devkit` version from [RubyInstaller Downloads][https://rubyinstaller.org/downloads/]
